...
public class DispositivoPareado extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        View header = inflater.inflate(R.layout.mostrar, lv, false);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
         ...
         */
        String item = String.valueOf(getListAdapter().getItem(position-1));
